...
if (env==='dev') {
	...
	var dirbisonscheduler		= 'E:/EP/BISONDOCS/github/prod/bison_scheduler'
	...
	var gitpullbisonweb			= 'git pull https://24rizalfauzi:*****r1zalf4Uzi*****@github.com/24rizalfauzi/bisonweb.git'
	var gitpullbisonscheduler			= 'git pull https://24rizalfauzi:*****r1zalf4Uzi*****@github.com/24rizalfauzi/bisonscheduler.git'
} else if (env==='test') {
	//APP
	var portApp		= 8513
	//DB
